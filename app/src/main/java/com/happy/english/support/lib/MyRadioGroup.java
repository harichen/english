...
public class MyRadioGroup extends LinearLayout
{
    ...
    public RadioButton findRadioButton(ViewGroup group)
    {
        ...
        for (int i = 0; i < len; i++)
        {
            ...
            {
                resBtn = findRadioButton((ViewGroup) group
                        .getChildAt(i));
            }
        }
        return resBtn;
    ...
    private void setCheckedStateForView(int viewId,
            boolean checked)
    {
        View checkedView = findViewById(viewId);
        if (checkedView != null
                && checkedView instanceof RadioButton)
        {
    ...
    public LayoutParams generateLayoutParams(
            AttributeSet attrs)
    {
        return new MyRadioGroup.LayoutParams(getContext(),
                attrs);
    }
            ...
            LinearLayout.LayoutParams
    {
                ...
                int heightAttr)
        {
            ...
            {
                width = a.getLayoutDimension(widthAttr,
                        "layout_width");
            }
            else
            {
            ...
            {
                height = a.getLayoutDimension(heightAttr,
                        "layout_height");
            }
            else
            {
